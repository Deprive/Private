...
namespace KurisuMorgana
{
    internal class KurisuMorgana
    {
        ...
        public KurisuMorgana()
        {
            ...
            menuW.AddItem(new MenuItem("waitfor", "Cast only on if Immobile")).SetValue(false);
            ...
            _menu.AddItem(new MenuItem("support", ":: Support Mode")).SetValue(true);
            _menu.AddItem(new MenuItem("dp", ":: Drawings")).SetValue(false);
