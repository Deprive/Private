    ...
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            MenuActivator = new Menu("Activator", "Activator").SetFontStyle(FontStyle.Regular, SharpDX.Color.Aqua);
            {
                ...
                items.AddItem(new MenuItem("BOTRK", "BOTRK").SetValue(false));
                items.AddItem(new MenuItem("GHOSTBLADE", "Ghostblade").SetValue(false));
                items.AddItem(new MenuItem("SWORD", "Sword of the Divine").SetValue(false));
                items.AddItem(new MenuItem("MURAMANA", "Muramana").SetValue(false));
                QuickSilverMenu = new Menu("QSS", "QuickSilverSash");
                items.AddSubMenu(QuickSilverMenu);
                QuickSilverMenu.AddItem(new MenuItem("AnyStun", "Any Stun").SetValue(false));
                QuickSilverMenu.AddItem(new MenuItem("AnySlow", "Any Slow").SetValue(false));
                QuickSilverMenu.AddItem(new MenuItem("AnySnare", "Any Snare").SetValue(false));
                QuickSilverMenu.AddItem(new MenuItem("AnyTaunt", "Any Taunt").SetValue(false));
                ...
                var summoners = MenuActivator.AddSubMenu(new Menu("Summoners", "Summoners"));
                {
                    ...
                    {
                        summonersHeal.AddItem(new MenuItem("SUMHEALENABLE", "Enable").SetValue(false));
                    ...
                    {
                        summonersBarrier.AddItem(new MenuItem("SUMBARRIERENABLE", "Enable").SetValue(false));
                    ...
                    {
                        summonersIgnite.AddItem(new MenuItem("SUMIGNITEENABLE", "Enable").SetValue(false));
                    }
                }
            }
            ...
            if (BaseType != CClass.GetType())
            {
                ...
                {
                    harass.AddItem(new MenuItem("HarassMana", "Min. Mana Percent").SetValue(new Slider(40, 100, 0)));
                ...
                {
                    laneclear.AddItem(new MenuItem("Lane.Enabled", ":: Enable Lane Farm!").SetValue(new KeyBind("v".ToCharArray()[0], KeyBindType.Toggle, true))).Permashow(true, "Marsman | Enable Lane Farm", SharpDX.Color.Aqua);
                    ...
                    var minManaMenu = new Menu("Min. Mana Settings", "Lane.MinMana.Title");
                    {
                        ...
                        minManaMenu.AddItem(new MenuItem("LaneMana.Enemy", "If Enemy Close %:").SetValue(new Slider(50, 100, 0))).SetFontStyle(FontStyle.Regular, Color.IndianRed);
